    ...
    <div className="font-sans text-green-900 relative">
      ...
      <header className="flex justify-between items-center py-6 px-10 bg-white shadow sticky top-0 z-40">
        ...
        <nav className="flex gap-8 text-lg font-medium items-center">
          ...
          <a href="/signup" className="hover:text-green-600 transition">Sign Up</a>
          <a href="/login" className="bg-green-600 text-white px-5 py-2 rounded-full hover:bg-green-700 transition">Login</a>
        </nav>
      </header>
